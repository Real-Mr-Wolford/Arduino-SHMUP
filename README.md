...
A simple shoot-'em-up game for the Arduino Nano using a SH1106-based 128×64 OLED display.
This project demonstrates basic game-loop structure, sprite rendering, collision detection, and joystick/button input handling on microcontrollers.
